...
// It returns a new Selection object with the matching elements.
func (this *Selection) HasNodes(nodes ...nml.Node) *Selection {
...
func winnow(sel *Selection, selector string, keep bool) []nml.Node {
...
// to get rid of (Not) the matching elements.
func winnowNodes(sel *Selection, nodes []nml.Node, keep bool) []nml.Node {
	return grep(sel, func(i int, s *Selection) bool {
...
// to get rid of (Not) the matching elements.
func winnowFunction(sel *Selection, f func(int, *Selection) bool, keep bool) []nml.Node {
	return grep(sel, func(i int, s *Selection) bool {
		return f(i, s) == keep
	})
}
